...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="/coffee/css/MainLoginSeller.css" />
...
<main class="main-container">
  ...
  <div class="salesRegistration">
    <botton class="generalProduct">일반상품 판매등록</botton>
    <botton class="groupBuying">공동구매 판매등록</botton>
  </div>
</main>
