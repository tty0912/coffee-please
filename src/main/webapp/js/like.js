function changeIcon() {
    var iconElement = document.querySelector('.productList__likeButton .myPageLike__button i.fa-solid.fa-heart');
    if (iconElement) {
...
function resetIcon() {
    var iconElement = document.querySelector('.productList__likeButton .myPageLike__button i.fa-solid.fa-heart-crack');
    if (iconElement) {
